 ...
 * @author happyyyyyyy
 */
public class searchByCar extends javax.swing.JFrame {

    /**
     * Creates new form searchByCar
     */
    public searchByCar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        searchBycar.setBackground(new java.awt.Color(51, 102, 0));
        searchBycar.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
        searchBycar.setForeground(new java.awt.Color(255, 255, 255));
  ...
  this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(searchByCar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new searchByCar().setVisible(true);
            }
        });
    }
